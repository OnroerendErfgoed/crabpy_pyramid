...
@view_config(
    route_name="list_gemeenten", renderer="capakey_listjson", accept="application/json"
)
...
@view_config(
    route_name="get_gemeente", renderer="capakey_itemjson", accept="application/json"
)
...
@view_config(
    route_name="list_kadastrale_afdelingen",
    renderer="capakey_listjson",
    accept="application/json",
)
...
def get_perceel_by_sectie_and_id(request):
    ...
    Gateway = request.capakey_gateway()
    perceel_id = (
        str(request.matchdict.get("perceel_id1"))
        + "/"
...
def get_perceel_by_capakey(request):
    ...
    Gateway = request.capakey_gateway()
    capakey = (
        str(request.matchdict.get("capakey1"))
        + "/"
