...
straat = {
    "@context": "https://docs.basisregisters.vlaanderen.be/context/straatnaam/2023-02-28"
...
adres = {
	...
	"volledigAdres": {
		"geografischeNaam": {
			"spelling": "Sint-Jansvest 50, 9000 Gent",
			"taal": "nl"
		}
	},
	"adresPositie": {
...
postinfo_1020 = {
	"@context": "https://docs.basisregisters.vlaanderen.be/context/postinfo/2023-02-28/postinfo_detail.jsonld",
	"@type": "PostInfo",
	"identificator": {
		"id": "https://data.vlaanderen.be/id/postinfo/1020",
		"naamruimte": "https://data.vlaanderen.be/id/postinfo",
