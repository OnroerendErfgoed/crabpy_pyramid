...
def main(global_config, **settings):
    ...
    config.add_route('get_gemeente_by_niscode', '/get_gemeente_by_niscode/{niscode}')
    config.add_route('list_kadastrale_afdelingen', '/capakey/gemeenten/{gemeente_id}/afdelingen')
    includeme(config)
    config.scan()
