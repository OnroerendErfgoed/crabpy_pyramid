...
def main(global_config, **settings):
    ...
    config.add_route('get_gewesten_by_id', '/crab/gewesten/{gewest_id}')
    config.add_route('list_gemeenten', '/crab/gemeenten')
    config.add_route('get_gemeente', '/crab/gemeenten/{gemeente_id}')
